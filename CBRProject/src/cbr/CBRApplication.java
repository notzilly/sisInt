...
public class CBRApplication implements StandardCBRApplication {
	...
	private NNConfig getSimilarityConfig() {
		...
		Attribute attribute0 = new Attribute("R3AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute0,
		...
		Attribute attribute1 = new Attribute("R3PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute1,
		...
		Attribute attribute2 = new Attribute("R3AceitouRetruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute2,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute2, 1.00);
		Attribute attribute3 = new Attribute("R3PediuRetruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute3,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute3, 1.00);
		Attribute attribute4 = new Attribute("R3AceitouTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute4,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute4, 1.00);
		Attribute attribute5 = new Attribute("R3PediuTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute5,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute5, 1.00);
		Attribute attribute6 = new Attribute("R3AceitouEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute6,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute6, 1.00);
		Attribute attribute7 = new Attribute("R3PediuEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute7,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute7, 1.00);
		Attribute attribute8 = new Attribute("R3CartaAdv", DescCaso.class);
		simConfig
				.addMapping(
						attribute8,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute8, 1.00);
		Attribute attribute9 = new Attribute("R3CartaMinha", DescCaso.class);
		simConfig
				.addMapping(
						attribute9,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute9, 1.00);
		Attribute attribute10 = new Attribute("R2AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute10,
		...
		Attribute attribute11 = new Attribute("R2PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute11,
		...
		Attribute attribute12 = new Attribute("R2AceitouRetruco",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute12,
		...
		Attribute attribute13 = new Attribute("R2PediuRetruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute13,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute13, 1.00);
		Attribute attribute14 = new Attribute("R2AceitouTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute14,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute14, 1.00);
		Attribute attribute15 = new Attribute("R2PediuTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute15,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute15, 1.00);
		Attribute attribute16 = new Attribute("R2AceitouEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute16,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute16, 1.00);
		Attribute attribute17 = new Attribute("R2PediuEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute17,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute17, 1.00);
		Attribute attribute18 = new Attribute("R2CartaAdv", DescCaso.class);
		simConfig
				.addMapping(
						attribute18,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute18, 1.00);
		Attribute attribute19 = new Attribute("R2CartaMinha", DescCaso.class);
		simConfig
				.addMapping(
						attribute19,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute19, 1.00);
		Attribute attribute20 = new Attribute("R1AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute20,
		...
		Attribute attribute21 = new Attribute("R1PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute21,
		...
		Attribute attribute22 = new Attribute("R1AceitouRetruco",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute22,
		...
		Attribute attribute23 = new Attribute("R1PediuRetruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute23,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute23, 1.00);
		Attribute attribute24 = new Attribute("R1AceitouTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute24,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute24, 1.00);
		Attribute attribute25 = new Attribute("R1PediuTruco", DescCaso.class);
		simConfig
				.addMapping(
						attribute25,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute25, 1.00);
		Attribute attribute26 = new Attribute("R1AceitouEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute26,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute26, 1.00);
		Attribute attribute27 = new Attribute("R1PediuEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute27,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Equal());
		simConfig.setWeight(attribute27, 1.00);
		Attribute attribute28 = new Attribute("R1CartaAdv", DescCaso.class);
		simConfig
				.addMapping(
						attribute28,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute28, 1.00);
		Attribute attribute29 = new Attribute("R1CartaMinha", DescCaso.class);
		simConfig
				.addMapping(
						attribute29,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute29, 1.00);
		Attribute attribute30 = new Attribute("Carta1", DescCaso.class);
		simConfig
				.addMapping(
						attribute30,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute30, 1.00);
		Attribute attribute31 = new Attribute("CasoId", DescCaso.class);
		simConfig
				.addMapping(
						attribute31,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute31, 0.00);
		Attribute attribute32 = new Attribute("Carta2", DescCaso.class);
		simConfig
				.addMapping(
						attribute32,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute32, 1.00);
		Attribute attribute33 = new Attribute("Carta3", DescCaso.class);
		simConfig
				.addMapping(
						attribute33,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute33, 1.00);
		Attribute attribute34 = new Attribute("PontosMeus", DescCaso.class);
		simConfig
				.addMapping(
						attribute34,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute34, 1.00);
		Attribute attribute35 = new Attribute("PontosAdv", DescCaso.class);
		simConfig
				.addMapping(
						attribute35,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());

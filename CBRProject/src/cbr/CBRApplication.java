...
public class CBRApplication implements StandardCBRApplication {
	...
	private NNConfig getSimilarityConfig() {
		...
		Attribute attribute13 = new Attribute("R1AceitouRetruco",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute13,
		...
		Attribute attribute14 = new Attribute("R1PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute14,
		...
		Attribute attribute15 = new Attribute("R1AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute15,
		...
		Attribute attribute18 = new Attribute("R2PediuEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute18,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute18, 1.00);
		Attribute attribute19 = new Attribute("R2AceitouEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute19,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		...
		Attribute attribute23 = new Attribute("R2AceitouRetruco",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute23,
		...
		Attribute attribute24 = new Attribute("R2PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute24,
		...
		Attribute attribute25 = new Attribute("R2AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute25,
		...
		Attribute attribute28 = new Attribute("R3PediuEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute28,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		simConfig.setWeight(attribute28, 1.00);
		Attribute attribute29 = new Attribute("R3AceitouEnvido", DescCaso.class);
		simConfig
				.addMapping(
						attribute29,
						new jcolibri.method.retrieve.NNretrieval.similarity.local.Threshold());
		...
		Attribute attribute33 = new Attribute("R3AceitouRetruco",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute33,
		...
		Attribute attribute34 = new Attribute("R3PediuValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute34,
		...
		Attribute attribute35 = new Attribute("R3AceitouValeQuatro",
				DescCaso.class);
		simConfig
				.addMapping(
						attribute35,
